...
class StudentGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("A10DanceWebapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Student entity")
        ...
        .formParam("client_id", "A10DanceWebapp")
        ...
        .repeat(2) {
            ...
            .post("/api/students")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "rollNumber":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "email":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
